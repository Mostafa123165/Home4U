...
public interface RequestSelectCustomPackageMapper extends BaseMapper<RequestSelectCustomPackage, RequestSelectCustomPackageDto> {
    ...
    RequestSelectCustomPackage UpdateMap(RequestSelectCustomPackageDto requestSelectCustomPackageDto, @MappingTarget RequestSelectCustomPackage selectCustomPackage);
}